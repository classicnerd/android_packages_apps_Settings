...
/**
 * The "dialog" that shows from "Changelog" in the Settings app.
 * Based off of SettingsLicenseActivity.java.
...
public class ChangelogActivity extends Activity {
    ...
    private static final String DEFAULT_CHANGELOG_PATH = "/system/etc/CHANGELOG.html.gz";
    private static final String PROPERTY_CHANGELOG_PATH = "ro.config.license_path";
    ...
    private class ChangelogLoader implements Runnable {
        ...
        private static final String INNER_TAG = "ChangelogActivity.ChangelogLoader";
        ...
        public ChangelogLoader(String fileName, Handler handler) {
            mFileName = fileName;
            mHandler = handler;
        }
        ...
        public void run() {
            ...
            try {
                ...
                Log.e(INNER_TAG, "Changelog HTML file not found at " + mFileName, e);
                status = STATUS_NOT_FOUND;
            } catch (IOException e) {
                Log.e(INNER_TAG, "Error reading changelog HTML file at " + mFileName, e);
            ...
            if ((status == STATUS_OK) && TextUtils.isEmpty(data)) {
                Log.e(INNER_TAG, "Changelog HTML is empty (from " + mFileName + ")");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String fileName = SystemProperties.get(PROPERTY_CHANGELOG_PATH, DEFAULT_CHANGELOG_PATH);
        if (TextUtils.isEmpty(fileName)) {
            Log.e(TAG, "The system property for the changelog file is empty.");
            showErrorAndFinish();
            return;
        }
        ...
        mHandler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                ...
                if (msg.what == ChangelogLoader.STATUS_OK) {
        ...
        CharSequence title = getText(R.string.changelog_activity);
        CharSequence msg = getText(R.string.changelog_activity_loading);
        ...
        Thread thread = new Thread(new ChangelogLoader(fileName, mHandler));
        thread.start();
    }
    ...
    private void showPageOfText(String text) {
        ...
        builder.setCancelable(true)
               .setView(mWebView)
               .setTitle(R.string.changelog_activity);
    ...
    private void showErrorAndFinish() {
        mSpinnerDlg.dismiss();
        mSpinnerDlg = null;
        Toast.makeText(this, R.string.changelog_activity_unavailable, Toast.LENGTH_LONG)
                .show();
        finish();
    }
}
